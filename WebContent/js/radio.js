	...
	var html = `<div class="questionItem" id="q${curid}" data-qid="${curid}">
		<div class="questionItem_name">
			<div style="float:left;overflow:auto;width:100%;">
				...
				<span class="questionItem_name_ismustSelect" style="color: red;">${subject.isrequired?"*":""}</span>
			</div>
...
bind(".questionTypeSelect", ".radio", ".testlist", ".radioEdit", ".cover_radio", function(){
	...
	loadObjT({title:"", score:[10, 7, 5, 3, 1], text:["很满意", "比较满意", "一般", "比较不满意", "很不满意"], type:0, isrequired:true});
	...
	qitem.find(".questionItem_name_ismustSelect").text(subject.isrequired?"*":"");
...
bind(".questionTypeSelect", ".checkBox", ".testlist", ".checkBoxEdit", ".cover_checkbox", function(){
	...
	loadObjC({title:"", text:["", "", "", ""], type:1, isrequired:true});
...
bind(".questionTypeSelect", ".textArea", ".testlist", ".textAreaEdit", ".cover_textarea", function(){
	...
	loadObjA({title:"", text:"", type:0, isrequired:true});
...
function addObjT(){
	...
	let isRequired = $("input#risRequired").get(0).checked;
	var testObj = {
...
function addObjC(){
	...
	let isRequired = $("input#cisRequired").get(0).checked;
	var testObj = {
...
function addObjA(){
	...
	let isRequired = $("input#fisRequired").get(0).checked;
